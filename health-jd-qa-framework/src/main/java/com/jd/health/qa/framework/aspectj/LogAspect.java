package com.jd.health.qa.framework.aspectj;

import cn.hutool.core.util.StrUtil;
import com.jd.health.qa.common.annotation.Log;
import com.jd.health.qa.common.enums.BusinessStatus;
...
public class LogAspect {
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(com.jd.health.qa.common.annotation.Log)")
